...
<div class="mt-2">
    ...
    <input class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="name" name="name" type="text" required
        placeholder="Nome" aria-label="Name" value="{{ $course->name ?? old('name') }}">
</div>
<div class="mt-2">
...
<div class="py-2">
    <label class="block text-sm text-gray-600" for="available">
        <input name="available" id="available" type="checkbox" aria-label="available" name="available" value="1"
